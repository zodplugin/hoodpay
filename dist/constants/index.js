...
export const HOODPAY_API_ENDPOINTS = {
    ...
    LIVE_PAYMENTS: {
        ...
        SELECT_PAYMENT_METHOD: 'public/payments/hosted-page/{paymentId}/select-payment-method',
        FILL_CUSTOMER_EMAIL: 'public/payments/hosted-page/{paymentId}/customer_email',
    ...
    WEBHOOKS: {
        ...
        RESET_WEBHOOK_SECRET: 'dash/businesses/{businessId}/settings/developer/webhooks/reset-secret',
        DELETE_WEBHOOK: 'dash/businesses/{businessId}/settings/developer/webhooks/{webhookId}',
    },
